...
class VisLocDatasetTrain(Dataset):
    ...
    def shuffle(self, ):
            ...
            # --- FIX: Add a safety check before attempting to access index 0 ---
            if len(self.samples) > 0:
                ...
                print("WARNING: self.samples is empty! No valid batches of size {} could be formed.".format(self.shuffle_batch_size))
                print("Consider lowering `shuffle_batch_size` or relaxing your uniqueness constraints.")
